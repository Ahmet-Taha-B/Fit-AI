...
gibi takip soruları anlıyorum! 🎯""",
        ...
        "add_custom_style": "➕ Yeni Stil Ekle",
        "style_name_exists": "⚠️ Bu isimde bir stil zaten var!",
        "delete_style": "🗑️ Stili Sil",
        "style_saved": "✅ Stil kaydedildi!",
        "default_custom_name": "Özel Koçum",
        "default_custom_prompt": "Sen yardımsever bir koçsun.",
...
I understand follow-up questions like these! 🎯""",
        ...
        "add_custom_style": "➕ Add New Style",
        "style_name_exists": "⚠️ A style with this name already exists!",
        "delete_style": "🗑️ Delete Style",
        "style_saved": "✅ Style saved!",
        "default_custom_name": "My Custom Coach",
        "default_custom_prompt": "You are a helpful coach.",
